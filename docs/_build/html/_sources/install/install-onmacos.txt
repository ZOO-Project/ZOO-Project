...
3. Then, create a ``src`` directory and inside that directory download the `gettext source code <http://www.gnu.org/software/gettext/#TOCdownloading>`__ and
   uncompress it. Now, compile gettext with the following commands to produce a universal binary :
...
4. Compile and install ZOO-Kernel
