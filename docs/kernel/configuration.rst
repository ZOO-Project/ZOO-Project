...
* ``globalNamespace``: (optional) set it to the user name you want to
  use as the global namespace for services not defining any namespace.
  By default, the ZOO-Kernel will use "anonymous" as the global
  namespace.
