...
following:
   ...
   * `argo`: 
      ...
      <https://github.com/ZOO-Project/zoo-argowf-runner>`_).
...
<https://github.com/ZOO-Project/zoo-calrissian-runner>`_.
...
.. code-block:: guess
       ...
       docker build . -t zoo-project/zoo-project-dru:myversion-X.Y.Z -f docker/dru/Dockerfile
...
.. warning::
  In case you did not set ``cwl2ogc_schema`` in the ``openapi`` section
  of the ``oas.cfg`` file, the schemas generated by the cwl2ogc Python
  package will replace the ones presented here.
